...
// ONLY handle direct POST requests to this file (for form submissions)
// Pagination requests are handled through index.php routing
if (basename($_SERVER['PHP_SELF']) === 'salescontroller.php') {
    ...
    // If directly accessed without proper parameters
    http_response_code(400);
    header('Content-Type: application/json');
